class ElementorWidgetMake extends elementorModules.frontend.handlers.Base {
    
    getDefaultSettings() {
        return {
            selectors: {
               carousel: '.et-make.swiper-container',
            }
        };
    }
    ...
    bindEvents() {
        ...
        if (this.elements.$carousel.length) {
            ...
            var $scope    = this.elements.$carousel,
                ...
                rows      = $scope.data('carousel-carousel-rows'),
...
jQuery( window ).on( 'elementor/frontend/init', () => {
    elementorFrontend.elementsHandler.attachHandler( 'et_make', ElementorWidgetMake );
});