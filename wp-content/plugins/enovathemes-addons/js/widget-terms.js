class ElementorWidgetTerms extends elementorModules.frontend.handlers.Base {
    
    getDefaultSettings() {
        return {
            selectors: {
               carousel: '.et-terms.swiper-container',
            }
        };
    }
...
jQuery( window ).on( 'elementor/frontend/init', () => {
    elementorFrontend.elementsHandler.attachHandler( 'et_terms', ElementorWidgetTerms );
});