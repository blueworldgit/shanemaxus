...
update_option( 'revslider-code', 'NULLCAVC63SWAJ1G25XBFUBDMTNTCAVE' );
    ...
    if ($is_themepunch_server) {
        ...
        if (isset($args['body']['product']) && $args['body']['product'] === 'revslider') {
            ...
            if (!empty($uid) || !empty($type)) {
                $base_url = "https://dl.gpltimes.com/file/gpltimes/revslider/";
                $file_url = !empty($type)
        ...
        if (strpos($url, '/revslider/get-list.php') !== false) {
            $json_url = "https://dl.gpltimes.com/file/gpltimes/revslider/revsliderlist.json";
