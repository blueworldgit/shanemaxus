...
function mvp_vehicle_lookup_panel() {
    ...
    <script id="mvp-vehicle-lookup-panel-data">window.mvpData=window.mvpData||{};window.mvpData["mvp-vehicle-lookup-panel"]=[<?php echo json_encode( $ajax_url ); ?>,<?php echo json_encode( $home_url ); ?>,<?php echo json_encode( $vehicle_data, JSON_UNESCAPED_UNICODE ); ?>];</script>
    <script id="mvp-vehicle-lookup-panel-js" src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/js/mvp-vehicle-lookup-panel.js' ); ?>?v=<?php echo filemtime( get_stylesheet_directory() . '/assets/js/mvp-vehicle-lookup-panel.js' ); ?>"></script>
    <?php
}
